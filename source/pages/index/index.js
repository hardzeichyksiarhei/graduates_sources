...
$(function () {
    ...
    $('.owl-carousel').owlCarousel({
        ...
        loop: true,
        navText: [
            '<img class="owl-prev__icon img-responsive" src="img/arrow.svg" alt="Arrow">',
            '<img class="owl-next__icon img-responsive" src="img/arrow.svg" alt="Arrow">'
        ]
    });
    ...
    $('#photo-grid').justifiedGallery({
        ...
        margins: 10,
        //lastRow: 'hide',
        selector: 'a, div:not(.spinner), figure',
    });
    ...
    function initPhotoSwipeFromDOM(gallerySelector) {
        ...
        let parseThumbnailElements = function (el) {
            ...
            for (let i = 0; i < numNodes; i++) {
                ...
                imgEl = linkEl.getElementsByClassName('gallery__img')[0]; // <img> element
                ...
                if (workGridItemEl.children.length > 1) {
                    // <caption> content
                    item.title = workGridItemEl.children[1].innerHTML;
                }
